# digital_output_frame.py
# Common frame for digital outputs used for qview.
...
class DigitalOutputFrame:
    ...
    def create_output_pin_command_labelframe(self, x_coor: int, y_coor: int, qp_signal: int) -> None:
        ...
        frame_root = tk.LabelFrame(self._tk_parent, text='Set Digital Output Pin')
        
        tk.Label(frame_root, text='Digital Output Pin Index').grid(row=0, column=0)
